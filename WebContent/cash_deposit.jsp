...
statement=connection.prepareStatement(new payment_processing().sql1(c,1));
...
<center  style="background: #fff">
		...
		<b><input     style=" background: #fff; "    type="text" class="e3"  name="product"  value="Investment Package"   readonly="readonly" /></b>
		</td>
		</tr>
		<tr>
		<td>
		<label   class="cus">Sub Total:</label> &nbsp;  &nbsp;   <input   style=" background: #fff; "   type="text"  class="e3" name="subtotal"  value="<%=resultSet.getString("token") %>"    readonly="readonly" />
		...
		<tr>
		<td>
		 <label  class="cus">Shipping Cost:</label> <input   style=" background: #fff; "   type="text" class="e3"  name="shipping"  value="<%=resultSet.getString("shipping") %>"   readonly="readonly" />
		...
		<tr>
		<td>
		   <label class="cus">Tax Payment:</label><input   style=" background: #fff; "   type="text" class="e3"  name="tax"           value="<%=resultSet.getString("tax") %>"    readonly="readonly" />
		</td>
		</tr>
		
		<tr>
		<td>
		  <label  class="cus">Investment Unit:  </label> 
		   <input    style=" background: #fff; "  type="text"  class="e3" name="total"         value="<%=resultSet.getString("token") %>"   readonly="readonly" />
